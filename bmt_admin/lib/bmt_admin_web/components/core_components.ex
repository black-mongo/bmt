defmodule BmtAdminWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(BmtAdminWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(BmtAdminWeb.Gettext, "errors", msg, opts)
    end
  end
