defmodule BmtAdmin.AccountsTest do
  use BmtAdmin.DataCase

  alias BmtAdmin.Accounts

  import BmtAdmin.AccountsFixtures
  alias BmtAdmin.Accounts.{User, UserToken}
  ...
  describe "items" do
    ...
    test "create_item/1 with valid data creates a item" do
      valid_attrs = %{desc: "some desc", name: "some name", password: "some password"}

      assert {:ok, %Item{} = item} = Accounts.create_item(valid_attrs)
      assert item.desc == "some desc"
      assert item.name == "some name"
      assert item.password == "some password"
    end
    ...
    test "update_item/2 with valid data updates the item" do
      ...
      assert {:ok, %Item{} = item} = Accounts.update_item(item, update_attrs)
      assert item.desc == "some updated desc"
      assert item.name == "some updated name"
      assert item.password == "some updated password"
    end
